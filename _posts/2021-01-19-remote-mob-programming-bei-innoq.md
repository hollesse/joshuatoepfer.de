---
layout: post
title: Remote Mob Programming bei INNOQ
date: '2021-01-19'
source: innoq
canonical_url: https://www.innoq.com/de/articles/2021/01/remote-mob-programming-bei-innoq/
published: false
render_with_liquid: false
---

[This article is also available in English](https://www.innoq.com/en/articles/2021/01/remote-mob-programming-bei-innoq/)

Der Begriff [„Mob Programming”](https://mobprogramming.org/) wurde von Woody Zuill folgendermaßen definiert: alle im Team arbeiten an der gleichen Sache, zur gleichen Zeit, am gleichen Ort und am gleichen Computer. [Remote Mob Programming](https://www.remotemobprogramming.org) nutzt anstatt eines Meeting-Raums den virtuellen Zoom Raum und anstatt eines Computers den geteilten Bildschirm. Das Team arbeitet bei dieser Methode intensiv zusammen.

Bei INNOQ nutzen einige Teams diese Methode erfolgreich in Kundenprojekten, teilweise sogar schon seit über zwei Jahren. Dabei ist die Themenseite [www.remotemobprogramming.org](https://www.remotemobprogramming.org) entstanden und ein [INNOQ Podcast zu dem Thema](https://www.innoq.com/de/podcast/061-remote-mob-programming/). Für diesen Artikel haben wir vier Teams aus drei unterschiedlichen Branchen gefragt, wie ihre Erfahrungen mit dieser besonderen Arbeitsmethodik sind und waren. Viel Spaß beim Lesen!
...
Interesse an Remote Mob Programming bekommen? INNOQ bietet einen Workshop namens [Remote Mob Programming erleben](https://www.innoq.com/de/topics/remote-mob-programming-erleben/) an um an einem Tag die Methode bei einer realistischen Fallstudie kennen zu lernen – und Spaß macht es auch, versprochen.
